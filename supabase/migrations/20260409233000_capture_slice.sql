...
create index if not exists idx_captures_user_captured_at on public.captures(user_id, captured_at desc);
create index if not exists idx_captures_user_status on public.captures(user_id, status, captured_at desc);
