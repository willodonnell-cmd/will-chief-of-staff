    ...
    <div className="space-y-6">
      ...
      <section className="grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
        <div className="rounded-[1.75rem] border border-line/75 bg-white/72 p-5 md:p-6">
          <p className="text-[0.72rem] uppercase tracking-[0.22em] text-text-subtle">Layout foundation</p>
        ...
        <div className="rounded-[1.75rem] border border-line/75 bg-white/68 p-5 md:p-6">
          <p className="text-[0.72rem] uppercase tracking-[0.22em] text-text-subtle">Shell note</p>
